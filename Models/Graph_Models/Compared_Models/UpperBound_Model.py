...
class Generator(nn.Module):
    def __init__(self, args, pad_idx=0, pretrain_src_embeddings=None, pretrain_tgt_embeddings=None):
        ...
        self.encoder_lstm = nn.LSTM(self.args.embedding_size + self.args.tagging_embedding_size*3,
    ...
    def encode(self, src_input, answer_tag_input, graph_tag_input, distance_tag_input, src_input_lengths):
        ...
        distance_tag_input = distance_tag_input[idx_sort]
        ...
        distance_tag_input_embed = self.dropout(self.distance_tagging_embeddings(distance_tag_input))

        input_embed = torch.cat([src_input_embed, answer_tag_input_embed, graph_tag_input_embed, distance_tag_input_embed], dim=-1)
