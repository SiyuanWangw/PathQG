...
from Our_Models.PathQG_Variational_Model import Generator # PathQG-V
import sys
sys.path.append('..')
sys.path.append('../..')
    ...
    def train(self):
        ...
        for epoch in range(self.args.num_epoches):
            ...
            for batch in range(n_chunk):
                ...
                # PathQG-Our_Models Model
                logits, selection_logits_1, selection_logits_2, KL_loss = model(src_input, src_input_length,
                                                    answer_tagging_input,
