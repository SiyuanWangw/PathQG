...
def init_args():
    ...
    parser.add_argument('--Selection_model_file', type=str, default='../../Model_Data/SceneGraph_QG/sel_model', help='directory of question generation model')
    ...
    parser.add_argument('--type_embedding_dense_size', type=int, default=200, help='size of word embedding')
    ...
    parser.add_argument('--entity_dense_size_2', type=int, default=1200, help='size of entity dense units')
    parser.add_argument('--entity_dense_size_3', type=int, default=300, help='size of entity dense units')
    ...
    parser.add_argument('--maxout_pool_size', type=int, default=2, help='maxout pool size')

    parser.add_argument('--attn_input_feed', type=bool, default=False, help='feed attn context into input')
    parser.add_argument('--batch_size', type=int, default=64, help='batch size')
    parser.add_argument('--num_epoches', type=int, default=5, help='number of epoches')
    parser.add_argument('--selection_num_epoches', type=int, default=5, help='number of epoches')
