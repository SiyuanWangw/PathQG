...
def init_args():
    ...
    # parser.add_argument('--QG_model_file', type=str, default='../../Model_Data/SceneGraph_QG/pathQG_model', help='directory of question generation model')
    parser.add_argument('--QG_model_file', type=str, default='../../Model_Data/SceneGraph_QG/pathQG_var_model', help='directory of question generation model')
    ...
    parser.add_argument('--type_embedding_dense_size', type=int, default=150, help='size of word embedding')
    ...
    parser.add_argument('--decoder_hidden_size', type=int, default=1200, help='size of decoder hidden states')
